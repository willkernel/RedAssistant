package com.willkernel.redassistant.utils;
...
public class Config {
    ...
    public static final String ACTION_RED_ENVELOPES_SERVICE_DISCONNECT = "com.willkernel.redassistant.ACCESSBILITY_DISCONNECT";
    public static final String ACTION_RED_ENVELOPES_SERVICE_CONNECT = "com.willkernel.redassistant.ACCESSBILITY_CONNECT";

    public static final String ACTION_NOTIFY_LISTENER_SERVICE_DISCONNECT = "com.willkernel.redassistant.NOTIFY_LISTENER_DISCONNECT";
    public static final String ACTION_NOTIFY_LISTENER_SERVICE_CONNECT = "com.willkernel.redassistant.NOTIFY_LISTENER_CONNECT";
    ...
    public boolean isEnableAlipay() {
        return preferences.getBoolean(KEY_ENABLE_ALIPAY, true) ;
    }
