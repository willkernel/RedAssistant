package com.willkernel.redassistant.biz;
...
import com.willkernel.redassistant.controller.IStatusBarNotification;
import com.willkernel.redassistant.service.RedEnvelopesService;
import com.willkernel.redassistant.utils.AccessibilityHelper;
import com.willkernel.redassistant.utils.Config;
import com.willkernel.redassistant.utils.NotifyHelper;
 ...
 * @author LeonLee
 */
public class WechatAccessbilityBiz extends BaseAccessbilityBiz {

    private static final String TAG = "WechatAccessbilityBiz";
     ...
     * 不能再使用文字匹配的最小版本号
     */
    private static final int USE_ID_MIN_VERSION = 980;// 6.3.8 对应code为680,6.3.9对应code为700,6.5.3对应980
    ...
    public void onReceive(AccessibilityEvent event) {
        ...
        if (eventType == AccessibilityEvent.TYPE_NOTIFICATION_STATE_CHANGED) {
            ...
            if (RedEnvelopesService.isNotificationServiceRunning() && getConfig().isEnableNotificationService()) { //开启快速模式，不处理
                return;
            }
    ...
    /**
     * 是否为群聊天
     * 聊天列表:  ListView , id : com.tencent.mm:id/an3
     * 返回箭头 : ImageView, id: com.tencent.mm:id/rs  ,contentdesc: 返回
     * 标题: TextView, id: com.tencent.mm:id/gas
     */
...
//            id = "com.tencent.mm:id/adu";
            id = "com.tencent.mm:id/gd";
        } else if (wv == 1800) {
            id = "com.tencent.mm:id/gas";
        }
        String title = null;
    ...
    private void handleLuckyMoneyReceive() {
        ...
        if (event == Config.WX_AFTER_OPEN_HONGBAO) { //拆红包
            if (wechatVersion < USE_ID_MIN_VERSION) {
                ...
                if (wechatVersion == 980) {
                    buttonId = "com.tencent.mm:id/be_";
                }
                if (wechatVersion == 1800) {
                    buttonId = "com.tencent.mm:id/den";
                }
...
//        String viewId1 = "com.tencent.mm:id/a56";
//        String viewId2 = "com.tencent.mm:id/a57";
//        List<AccessibilityNodeInfo> list = nodeInfo.findAccessibilityNodeInfosByViewId(viewId1);
        List<AccessibilityNodeInfo> list = nodeInfo.findAccessibilityNodeInfosByText("领取红包");
        if (list != null && list.isEmpty()) {
            // 从消息列表查找红包
//            AccessibilityNodeInfo node = AccessibilityHelper.findNodeInfosById(nodeInfo, viewId2);
    ...
    public int getWechatVersion() {
        ...
        Log.e(TAG,"getWechatVersion "+ mWechatPackageInfo.versionCode);
